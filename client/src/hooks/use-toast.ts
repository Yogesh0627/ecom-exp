...
// Adapted from shadcn/ui's toast hook (itself adapted from react-hot-toast). A tiny reducer store
// so any component can call toast() without prop-drilling a provider handle.
