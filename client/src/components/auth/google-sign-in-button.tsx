...
/**
 * Starts Google sign-in. This is a full-page navigation to the backend's OAuth entry point (not an
 * XHR) — the backend redirects to Google, then back to /auth/callback with a one-time code.
 */
